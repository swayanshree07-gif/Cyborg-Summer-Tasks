...
Built an OpenCV-based vision system that analyzes a grid arena image, detects special colored cells, identifies start and goal positions, and maps everything to exact grid coordinates for navigation.
